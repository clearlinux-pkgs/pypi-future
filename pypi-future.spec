...
%prep
%setup -q -n future-0.18.3
cd %{_builddir}/future-0.18.3
pushd ..
cp -a future-0.18.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673625620
...
cp %{_builddir}/future-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-future/b41d323fb543c297b4ecc2a96425287c7dfdd5a4 || :
